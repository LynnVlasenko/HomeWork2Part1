...
typealias Humidity = Int // Вологість %
typealias Temperature = Int // Температура Сelsius(С)

var pressure: Pressure = 1005
var humidity: Humidity = 80
var temperature: Temperature = 12
...
var profileInfo = (firstName: userName, surname: userSurname, age: userAge, height: userHeight, weight: userWeight, isMarried: isMarried)
var weatherInfo = (pressure, humidity, temperature)

profileInfo.weight = 80
profileInfo.age = 37
...
/*
 Xcode видає warning - я не підтвердила запропоновані варіанти,
 бо не впевнена чи потрібно це робити, відповідно до завдання.
 Але, для прикладу, прописала свій варіант для розрортання опціоналу нижче.
*/
...
//Optional binding - щоб розгорнути опціонал і вивести значення без запису Optional(true)
